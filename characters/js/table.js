...
angular.module('optc') .run(function($rootScope, $timeout, $storage, MATCHER_IDS) {
    ...
    var list_koreaTM_kizaru = [ 0603, 2034, 2035, 1707, 1808, 1853, 1889, 1916, 1941, 1972, 2000, 2251, 2025, 2023, 2007, 1985, 0649, 2050, 2048, 2043, 2041, 2039, 2031, 2029, 2027, 2013, 2062, 2060, 2037, 1527, 2017, 1976, 2015, 1943, 0654, 0836, 0865, 1930, 1772, 2046, 2045, 2044, 2021, 2019, 1997, 1995, 1933, 1932, 1931, 1725, 1766, 1690, 1818, 1242, 1003, 0852, 1397, 1399 ];
    ...
    var tableFilter = function(settings, data, index) {
        ...
        if (filters.koreaTM_kizaru && list_koreaTM_kizaru.indexOf(id) === -1){
            console.log("list koreaTM_kizaru: ", list_koreaTM_kizaru.indexOf(id));
            return false;
        }
        if (filters.koreaTM_bigmam && [2283, 852 ].indexOf(id) == -1) return false;
